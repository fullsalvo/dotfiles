...
(let ((blue "#71899d")
  ...
  (custom-theme-set-faces
   ...
   `(mode-line ((t (:foreground ,background :background ,text :overline nil :underline nil))))
   `(mode-line-buffer-id ((t (:weight normal :foreground ,background))))
   `(mode-line-emphasis ((t (:weight bold))))
   `(mode-line-highlight ((t (:box (:line-width 1 :color ,background)))))
   `(mode-line-inactive ((t (:weight light :foreground ,background :distant-foreground ,background :background ,text-3 :overline nil))))
   ...
   `(font-latex-sectioning-1-face ((t (:family "Office Code Pro"))))
   `(font-latex-sectioning-2-face ((t (:family "Office Code Pro"))))
   `(font-latex-sectioning-3-face ((t (:family "Office Code Pro"))))
   `(font-latex-sectioning-4-face ((t (:family "Office Code Pro"))))
   `(font-latex-sectioning-5-face ((t (:family "Office Code Pro"))))
